...
export const dashboardBrand = {
  name: "WyvernBox",
  shellLabel: "WyvernBox cinema operations shell",
  shellDescription: "Cinema Ticket Booking Dashboard",
};
...
export const dashboardFooterCopy = "WyvernBox — Cinema Ticket Booking Dashboard";

export const headerFallback = {
  icon: UserRound,
  name: "Workspace",
  description: "Unified operations view for the WyvernBox cinema ticket booking dashboard.",
};
