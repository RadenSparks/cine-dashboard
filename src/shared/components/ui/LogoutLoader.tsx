  ...
  return (
    <AnimatePresence mode="wait">
      {show && (
        ...
        >
          <div className="relative bg-white dark:bg-neutral-900 rounded-xl shadow-2xl px-10 py-12 min-w-[340px] max-w-xs border border-blue-200 dark:border-blue-900">
