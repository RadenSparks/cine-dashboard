...
const AppButtonComponent: React.FC<AppButtonProps> = ({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={cn(
        "inline-flex items-center justify-center gap-2 rounded-full border font-semibold tracking-[0.01em] transition-all duration-200 transform-gpu hover:-translate-y-0.5 hover:scale-[1.02] active:scale-[0.98]",
