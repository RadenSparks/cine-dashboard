      ...
      {previewUrl && (
        ...
        >
          <motion.div
            ...
            className="dashboard-panel max-w-[92vw] max-h-[92vh] rounded-[28px] p-4"
          >
            <div className="relative overflow-hidden rounded-[22px]">
              <button
                aria-label="Close preview"
                onClick={onClose}
                className="absolute right-3 top-3 z-20 rounded-full border border-slate-200 bg-white/85 p-2 text-slate-700 transition hover:bg-white dark:border-slate-700 dark:bg-slate-800/85 dark:text-slate-200"
                type="button"
              >
