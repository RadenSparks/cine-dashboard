  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-sm p-4">
      <div className="bg-white rounded-xl shadow-lg max-w-sm w-full p-8 relative">
        <h3 className="text-lg font-bold mb-4 text-red-600 break-words font-audiowide" style={{ fontFamily: 'Audiowide, sans-serif' }}>Delete Folder</h3>
        <p className="mb-4 break-words text-sm font-farro" style={{ fontFamily: 'Farro, sans-serif' }}>
