    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative bg-white/90 dark:bg-zinc-900/90 border border-blue-100 dark:border-zinc-800 rounded-2xl shadow-2xl w-full max-w-4xl p-0 overflow-hidden"
        >
          {/* Header */}
          ...
          <div className="flex flex-col md:flex-row gap-8 p-8">
            ...
            >
              ...
              <div className="flex justify-end gap-2 mt-6">
                <button
                  type="button"
                  className="px-4 py-2 bg-gray-200 dark:bg-zinc-700 text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-300 dark:hover:bg-zinc-600 transition"
                  onClick={onClose}
                >
                  Cancel
                </button>
