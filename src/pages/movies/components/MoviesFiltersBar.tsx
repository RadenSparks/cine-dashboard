...
export default function MoviesFiltersBar({
  ...
  const selectClasses = {
    trigger:
      "h-[46px] rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-slate-100 shadow-none hover:border-slate-300 dark:hover:border-slate-600",
