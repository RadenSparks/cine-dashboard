import type { Genre, Movie } from "../../../entities/type";
import MovieTable from "./MovieTable";
import { Pagination } from "../../../components/UI/DashboardPrimitives";
...
export default function MoviesTableContainer({
  ...
  return (
    <div className="space-y-4">
      <div className="overflow-hidden rounded-[24px] border border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-900/82">
        <MovieTable
          movies={movies}
          genres={genres}
          onEdit={onEdit ?? (() => {})}
