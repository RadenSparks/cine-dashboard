...
import { dashboardNavItems, dashboardNavSections, getRoleLabel } from "../../data/dashboardNavigation";
import { TextGenerateEffect as TextGeneratedEffect } from "../UI/TextGeneratedEffect";
  ...
  return (
    <>
      ...
      <div className="sticky top-0 z-40 flex items-center justify-between border-b border-slate-700/50 bg-gradient-to-r from-slate-800/95 via-slate-800/90 to-slate-900/92 px-4 py-3 backdrop-blur dark:border-slate-800/60 dark:bg-slate-900/98 md:hidden">
        <div>
          <div className="text-xs uppercase tracking-[0.18em] text-cyan-400/80 dark:text-cyan-300 font-bold">Cine</div>
