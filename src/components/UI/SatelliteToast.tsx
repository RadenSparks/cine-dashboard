...
const Notification = ({ notification, onClose }: { notification: ToastNotification; onClose: () => void }) => {
  const {
    ...
    contentFontColor = "#cbd5e1",
    contentFontWeight = 400,
    bodyBorderRadius = "24px",
    bodyBorderColor = "rgba(148,163,184,0.2)",
    bodyBorderWidth = "1px",
    typeIconContainerBorderRadius = "18px",
    typeIconContainerBorderColor = "rgba(255,255,255,0.08)",
    typeIconContainerBorderWidth = "1px",
    typeIconColor = "#fff",
    iconYOffset = "0px",
    iconXOffset = "0px",
    closeIconBorderRadius = "50%",
    closeIconBgColor = "rgba(255,255,255,0.92)",
    closeIconFgColor = "#0f172a",
    closeIconHoverBgColor = "#ffffff",
    closeIconHoverFgColor = "#020617",
    closeIconOutlineColor = "rgba(148,163,184,0.28)",
    closeIconOutlineWidth = "1px",
    timerColor = "#f59e0b",
    timerBgColor = "rgba(255,255,255,0.18)",
    timerAnimationType = "shrink",
    longevity = 5000,
    animationDuration = 600,
    customIcon,
    satelliteInFront = true,
    satelliteColor = "#f8fafc",
    showSatelliteAnimation = false,
    paddingLTR = "1.2rem 3rem 1.2rem 96px",
    paddingRTL = "1.2rem 96px 1.2rem 3rem",
  } = notification;
