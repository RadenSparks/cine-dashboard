...
function StatCard({
  ...
  return (
    <div className={`flex flex-col items-center justify-center rounded-xl shadow-md border border-blue-100 dark:border-zinc-800 bg-white/90 dark:bg-zinc-900/90 px-6 py-5 w-full font-red-rose`} style={{ fontFamily: 'Red Rose, sans-serif' }}>
