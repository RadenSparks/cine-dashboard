...
import { type User, type Tier } from "@/shared/types/entities";
      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="relative bg-white/90 dark:bg-zinc-900/90 border border-blue-100 dark:border-zinc-800 rounded-xl shadow-2xl w-full max-w-lg p-0 overflow-hidden hide-scrollbar"
