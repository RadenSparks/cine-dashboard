...
import { MOCK_BOOKINGS, type Booking } from "@/shared/mocks";
...
const bookingStatuses: BookingFilters["status"][] = ["all", "CONFIRMED", "PENDING", "CANCELLED"];
              ...
              <div className="bg-white/95 dark:bg-zinc-900/95 rounded-xl shadow-md border border-purple-100 dark:border-zinc-800 p-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={e => {
                      setFilters({ ...filters, dateRange: e.target.value as BookingFilters["dateRange"] });
                      setCurrentPage(0);
                    }}
