    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-white dark:bg-zinc-900 rounded-xl shadow-2xl max-w-7xl w-full p-0 relative flex flex-col md:flex-row items-stretch my-12 border border-blue-100 dark:border-zinc-800 hide-scrollbar"
          style={{
            margin: "auto",
            position: "relative",
            maxHeight: "96vh",
