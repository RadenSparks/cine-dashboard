...
import { type Movie, type Image } from "@/shared/types/entities";
...
import { fetchFoldersAsync, fetchFolderListAsync, uploadImageToFolderAsync } from "@/store/slices";
import { buildFolderTree } from "@/shared/utils/folderTreeUtils";
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative bg-white/90 dark:bg-zinc-900/90 border border-blue-100 dark:border-zinc-800 rounded-xl shadow-2xl w-full max-w-6xl p-0 overflow-hidden hide-scrollbar"
          style={{
            maxHeight: "90vh",
            overflowY: "auto",
          }}
          ...
          <div className="modal-scrollbar">
            ...
            <div className="flex flex-col md:flex-row gap-8 p-8">
              ...
              >
                  ...
                  <div className="flex gap-2 items-center">
                    <div className="relative w-full">
                      <input
                        ...
                        required
                        className="border border-blue-200 dark:border-zinc-700 bg-white/80 dark:bg-zinc-800/80 px-4 py-2 rounded-lg w-full focus:ring-2 focus:ring-blue-400 focus:outline-none text-blue-700 dark:text-blue-200 font-semibold transition-all shadow-sm"
                      ...
                      <input
                        ...
                        onChange={async (e) => {
                          ...
                          try {
                            ...
                            const uploaded = await dispatch(uploadImageToFolderAsync({ file: f, folderName: 'posters' })).unwrap();
                            // set poster URL on current movie
                            onChange({ ...current, poster: uploaded.url });
                            // refresh folders/images
                            dispatch(fetchFoldersAsync());
                            dispatch(fetchFolderListAsync());
                          } catch {
                            // ignore; slice handles errors. Could add toast here.
                          } finally {
                ...
                <div className="flex justify-end gap-2 mt-6">
                  <AppButton color="default" variant="soft" type="button" onClick={onClose}>
                    Cancel
                  </AppButton>
            ...
            {showMediaPicker && (
              <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
                <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-2xl max-w-5xl w-full max-h-[90vh] flex flex-col border border-gray-200 dark:border-zinc-700 overflow-hidden">
                  {/* Header */}
            ...
            {showPosterSelector && (
              <div className="fixed inset-0 z-[101] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
                <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-2xl max-w-2xl w-full max-h-[80vh] flex flex-col border border-gray-200 dark:border-zinc-700 overflow-hidden">
                  {/* Header */}
