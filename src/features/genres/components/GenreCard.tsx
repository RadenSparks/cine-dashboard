...
export default function GenreCard({
  ...
  return (
    <div
      className={"relative z-10 bg-white dark:bg-zinc-900 rounded-xl shadow-lg border border-blue-100 dark:border-zinc-800 p-6 flex flex-col items-center justify-between min-h-[260px] transition " + (genre.deleted ? "opacity-60 grayscale" : "")}
    >
      ...
      {isEditing ? (
        <>
          <input
            ...
            className="border rounded-lg px-2 py-1 text-base mb-2 w-full text-blue-700 dark:text-blue-200 font-red-rose"
            style={{ fontFamily: 'Red Rose, sans-serif' }}
            disabled={genre.deleted}
          />
          <select
            className="border rounded-lg px-2 py-1 text-base bg-white dark:bg-zinc-800 text-blue-700 dark:text-blue-200 mb-2 font-red-rose"
            style={{ fontFamily: 'Red Rose, sans-serif' }}
          ...
          <div className="flex gap-2 mt-2">
            ...
            <AppButton color="default" variant="soft" onClick={() => setEditingGenreId(null)}>
              Cancel
            </AppButton>
          </div>
        </>
