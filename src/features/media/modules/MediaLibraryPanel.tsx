...
import type { ToastRef } from "@/shared/lib/toast";
    ...
    <SectionCard title="Library contents" description="Browse folder contents, preview images, and perform bulk actions against the current folder.">
      <div className="space-y-4">
        ...
        <ImageSelectionToolbar
          ...
          toastRef={toastRef}
        />
        <div className="rounded-xl border border-slate-200 bg-white/85 p-4 shadow-sm dark:border-slate-700 dark:bg-slate-900/72">
          <ImagesGrid
            media={currentImages}
            selectedImages={selectedImages}
