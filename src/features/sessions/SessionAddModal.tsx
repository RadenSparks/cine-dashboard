      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="bg-white dark:bg-zinc-900 rounded-xl shadow-2xl w-full max-w-4xl max-h-[95vh] overflow-y-auto relative border border-blue-100 dark:border-zinc-800"
