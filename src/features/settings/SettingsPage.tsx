...
const themeColors: AppearanceSettings["theme"][] = ["blue", "purple", "green"];
      ...
      {SETTINGS_SECTIONS.map(section => {
        ...
        return (
          <button
            ...
            className={`w-full text-left px-4 py-3 rounded-lg border flex items-center gap-3 transition font-red-rose ${
              isActive
    ...
    <>
      ...
      <div className="w-full hide-scrollbar space-y-6">
        <PageIntro
          ...
          icon={SettingsIcon}          showEvervault={true}        />
        ...
        <SectionCard title="Preference panels" description="Switch between account, notification, appearance, privacy, and password settings from one consistent workspace shell.">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200 dark:border-zinc-700">
            ...
            <div className="rounded-xl border border-red-200 bg-red-50 p-6 dark:border-red-800/70 dark:bg-red-950/30">
              <div>
